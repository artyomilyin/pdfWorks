...
from wx import Frame, Panel, Button, StatusBar
...
class PickAndConvertFrame(Panel):
    ...
    def __init__(self, master):
        ...
        #self.loadButton = Button(self, label="Выбрать файлы", command=self.show_load_dialog)
        #self.loadButton.grid(sticky="we")
        #self.convertButton = Button(self, label="Склеить", command=self.show_save_dialog, state='disabled')
        self.convertButton = Button(self, label="Склеить", )
        self.convertButton
